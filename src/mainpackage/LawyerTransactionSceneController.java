 ...
 * @author Hasan
 */
public class LawyerTransactionSceneController implements Initializable {
    ...
    @FXML
    private void dashbrdButtonOnclick(ActionEvent event) throws IOException {
    ...
    @FXML
    private void signOutButtonOnclcik(ActionEvent event) throws IOException {
